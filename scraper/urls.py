from scraper.constants import LISBON_FREGUESUAS, LISBON_MUNICIPALITY, BASE_URL
...
def make_base_urls():
    urls = []
    for freguesia in LISBON_FREGUESUAS:
        urls.append(f"{BASE_URL}/{LISBON_MUNICIPALITY}/{freguesia}/")
    return urls
